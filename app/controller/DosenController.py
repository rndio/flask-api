...
def save():
  try:
    ...
    print(e)
    return response.badRequest('', 'Gagal Menambahkan Data Dosen')
...
def ubah(id):
  try:
    ...
    return response.success(input, 'Sukses Mengubah Data Dosen')
  except Exception as e:
    print(e)
    return response.badRequest([], 'Gagal Mengubah Data Dosen')
...
def hapus(id):
  try:
    ...
    return response.success('', 'Sukses Menghapus Data Dosen')
  except Exception as e:
    print(e)
    return response.badRequest([], 'Gagal Menghapus Data Dosen')